...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 w-full shrink-0 items-center rounded-md font-medium text-sidebar-foreground/70 text-xs outline-none ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
>(({ className, ...props }, ref) => (
  <li
    ...
    className={cn(
      "group/menu-item relative flex w-full flex-col gap-1 text-sm",
      className,
    )}
    {...props}
  />
...
const SidebarMenuSubItem = React.forwardRef<
  ...
  React.ComponentProps<"li">
>(({ className, ...props }, ref) => (
  <li ref={ref} className={cn("flex justify-between", className)} {...props} />
));
